...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    ...
    description: imovel.descricao || `${tipoLabels[imovel.tipo]} em ${imovel.cidade}`,
  }
}
            ...
            <div className="sticky top-8 space-y-6">
              ...
              <Card>
                <CardContent className="pt-6">
                  <p className="text-sm text-muted-foreground">Código do imóvel</p>
                  <p className="font-mono text-lg"># {imovel.id.toString().padStart(6, '0')}</p>
                </CardContent>
              </Card>
            </div>
          </div>
